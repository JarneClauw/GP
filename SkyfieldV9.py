...
def location():
    ...
    # Check of er al een tabel bestaat, zoniet maak een
    ...
    # Blijven herhalen tot hij choose kiest
    while True:
        # Bestaande locaties printen
        print("")
        print("---- Locations ----")
