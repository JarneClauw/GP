## Version 5 ##
# Tle terug met BS4 na problemen, tijdzone, probleem met de overgang (v1)
...
##_____LIBRARIES_____##
from skyfield.api import load, Topos, EarthSatellite    # Skyfield (main)
...
##_____TOPOS_____##
vti = earth + Topos('50.855108 N', '2.864798 E', elevation_m=20)            # VTI - locatie
vtiISS = Topos('50.855108 N', '2.864798 E', elevation_m=20)                 # VTI - locatie (voor ISS)
vtiTemp = 15                                                                # Instelbare temperatuur
vtiPress = 1013                                                             # Instelbare druk

reningelst = earth + Topos('50.815143 N', '2.771039 E', elevation_m=34)     # Jarne thuis - locatie
reningelstISS = Topos('50.815143 N', '2.771039 E', elevation_m=34)          # Jarne thuis - locatie
...
#serialcomm = serial.Serial(port='COM6', baudrate=9600, timeout=1)           # Opzetten van seriele communicatie
...
readySign = input("Are you ready? Type 'ready': ")                          # Sein geven dat je klaar bent 
...
if (readySign == "ready" and inputStart <=10 and inputTarget <=11):
    while True:
        ...
        #Vergeet de poort niet te benoemen!
